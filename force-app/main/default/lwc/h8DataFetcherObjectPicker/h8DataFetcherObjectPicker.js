/**
 * @description       : LWC component for selecting a Salesforce object and field, with support for filtering by object and field types, and integration with Flow Builder.
...
import getObjects from '@salesforce/apex/H8DataFetcherObjectPickerController.getObjects';
import {standardObjectOptions} from 'c/h8DataFetcherObjectPickerUtils';


import {flowComboboxDefaults, formattedValue, getDataType, isReference} from 'c/h8DataFetcherCPEComboboxUtils';

export default class H8DataFetcherObjectPicker extends LightningElement {
    @api name;
    @api masterLabel;
