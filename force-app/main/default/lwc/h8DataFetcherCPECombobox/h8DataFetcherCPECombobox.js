...
import Placeholder_Text from '@salesforce/label/c.DatafetcherManualReferenceAllowed';
import getObjectFields from '@salesforce/apex/H8DataFetcherFieldSelectorController.getObjectFields';
const OUTPUTS_FROM_LABEL = 'Outputs from '; 

export default class H8DataFetcherCPECombobox extends LightningElement {
    @api name;
    @api label;
    @api required = false;
